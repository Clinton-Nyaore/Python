...
class login_page:
    def __init__(self, root):
        ...
        label1 = Label(self.frame1, text= "Login", font=("times new roman", 40, "bold"), bg="yellow", fg="red").place(x=200,y=250)
        label2 = Label(self.frame1, text= "\nSystem", font=("times new roman", 40, "bold"), bg="yellow", fg="RoyalBlue1").place(x=162,y=300)
        label3 = Label(self.frame1, text= "Let's Code  with Clinton", font=("times new roman", 13, "bold"), bg="yellow", fg="brown4").place(x=100,y=360)
        ...
        if self.email_entry.get()=="" or self.password_entry.get()=="":
            ...
            try:
                ...
                if row == None:
                    ...
                    messagebox.showinfo("Success","Welcome to the Coding with  Clinton",parent=self.window)
